...
DJ::JECS::Examples::ExRendererModule::ExRendererModule(int32_t w, int32_t h) :
	WIDTH(w), HEIGHT(h)
{
...
void DJ::JECS::Examples::ExRendererModule::PreRender() const
{
	int32_t color = 0xFF;
...
void DJ::JECS::Examples::ExRendererModule::PostRender() const
{
...
SDL_Renderer& DJ::JECS::Examples::ExRendererModule::GetRenderer() const
{
	return *_renderer;
}

SDL_Texture* DJ::JECS::Examples::ExRendererModule::GetTexture(const std::string& key)
{
...
SDL_Texture& DJ::JECS::Examples::ExRendererModule::LoadTexture(const std::string& path) const
{
